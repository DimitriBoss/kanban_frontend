    ...
    <div className="min-h-screen bg-slate-950 text-slate-100 flex flex-col relative font-sans">
          ...
          <div>
            {user ? (
              <button
                ...
                className="flex items-center gap-2 bg-gradient-to-r from-indigo-500 to-violet-600 hover:from-indigo-600 hover:to-violet-700 text-white text-xs font-semibold px-4 py-2 rounded-lg shadow-md shadow-indigo-500/15 hover:shadow-indigo-500/25 transition-all cursor-pointer"
              >
              ...
              <div className="flex items-center gap-3">
                ...
                <Link
                  to="/register"
                  className="bg-white/5 hover:bg-white/10 text-white border border-white/10 text-xs font-semibold px-4 py-2 rounded-lg transition-all"
                >
                  S'inscrire
                </Link>
              </div>
      ...
      <section className="max-w-7xl mx-auto w-full px-6 pt-36 pb-20 text-center relative z-10 flex flex-col items-center">
        ...
        <p className="text-slate-400 mt-6 text-base md:text-lg max-w-2xl leading-relaxed">
          Un espace de travail Kanban épuré, ultra-rapide et doté d'une interface en verre dépoli modernisée. Organisez vos tâches par simple glisser-déposer.
        </p>
        ...
        <div className="w-full max-w-5xl mt-20 p-4 rounded-2xl glass-panel relative border border-white/10 shadow-2xl overflow-hidden group">
          ...
          <div className="flex items-center justify-between px-4 py-3 border-b border-white/5 bg-slate-900/20 text-left">
            <div className="flex items-center gap-2">
              ...
              <span className="text-xs text-slate-500 ml-4 font-mono select-none">app.kanbanflow.com/boards/projet-refonte</span>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 p-4 text-left select-none relative z-0">
            ...
            <div className="bg-slate-900/40 border border-white/5 rounded-xl p-3 space-y-3">
              <div className="flex justify-between items-center pb-2">
                ...
                <span className="px-2 py-0.5 text-[10px] font-bold bg-white/5 text-slate-400 rounded-full">3</span>
              </div>
              
              <div className="bg-slate-950/40 border border-white/5 p-3 rounded-lg space-y-2">
                <h4 className="font-semibold text-xs text-slate-200">Rédiger les spécifications</h4>
                <p className="text-[10px] text-slate-500 line-clamp-2">Écrire l'architecture et les routes d'API.</p>
                <div className="flex justify-between items-center pt-1">
                  <span className="px-1.5 py-0.5 text-[8px] font-bold bg-indigo-500/10 text-indigo-300 rounded">Specs</span>
                  <div className="w-4 h-4 rounded-full bg-indigo-600 flex items-center justify-center text-[8px] font-bold text-white">D</div>
                </div>
              </div>

              <div className="bg-slate-950/40 border border-white/5 p-3 rounded-lg space-y-2 opacity-80">
                <h4 className="font-semibold text-xs text-slate-200">Intégrer Google Fonts</h4>
                <p className="text-[10px] text-slate-500 line-clamp-2">Charger Plus Jakarta Sans dans l'index.html.</p>
                <div className="flex justify-between items-center pt-1">
                  <span className="px-1.5 py-0.5 text-[8px] font-bold bg-emerald-500/10 text-emerald-300 rounded">Design</span>
                  <div className="w-4 h-4 rounded-full bg-violet-600 flex items-center justify-center text-[8px] font-bold text-white">F</div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-slate-900/40 border border-white/5 rounded-xl p-3 space-y-3">
              <div className="flex justify-between items-center pb-2">
                ...
                <span className="px-2 py-0.5 text-[10px] font-bold bg-white/5 text-slate-400 rounded-full">2</span>
              </div>
              ...
              <div className="bg-slate-950/40 border border-indigo-500/20 p-3 rounded-lg space-y-2 shadow-lg shadow-indigo-500/5 ring-1 ring-indigo-500/10 relative overflow-hidden">
                ...
                <h4 className="font-semibold text-xs text-indigo-300">Intégrer le Drag & Drop</h4>
                <p className="text-[10px] text-slate-400 line-clamp-2">Brancher dnd-kit sur les tâches et colonnes pour fluidifier le glisser-déposer.</p>
                <div className="flex justify-between items-center pt-1">
                  <span className="px-1.5 py-0.5 text-[8px] font-bold bg-indigo-500/20 text-indigo-300 rounded">Core</span>
                  <div className="w-4 h-4 rounded-full bg-indigo-600 flex items-center justify-center text-[8px] font-bold text-white">D</div>
                </div>
              </div>

              <div className="bg-slate-950/40 border border-white/5 p-3 rounded-lg space-y-2 opacity-95">
                <h4 className="font-semibold text-xs text-slate-200">Créer le ConfirmModal</h4>
                <p className="text-[10px] text-slate-500 line-clamp-2">Remplacer les window.confirm par une boîte de dialogue stylisée.</p>
                <div className="flex justify-between items-center pt-1">
                  <span className="px-1.5 py-0.5 text-[8px] font-bold bg-fuchsia-500/10 text-fuchsia-300 rounded">Modales</span>
                  <div className="w-4 h-4 rounded-full bg-slate-700 flex items-center justify-center text-[8px] font-bold text-white">A</div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-slate-900/40 border border-white/5 rounded-xl p-3 space-y-3">
              <div className="flex justify-between items-center pb-2">
                ...
                <span className="px-2 py-0.5 text-[10px] font-bold bg-white/5 text-slate-400 rounded-full">1</span>
              </div>
              ...
              <div className="bg-slate-950/40 border border-white/5 p-3 rounded-lg space-y-2 opacity-70 line-through decoration-slate-600">
                <h4 className="font-semibold text-xs text-slate-400">Créer la page de login</h4>
                <p className="text-[10px] text-slate-600 line-clamp-1">Formulaire moderne en glassmorphism.</p>
                <div className="flex justify-between items-center pt-1">
                  <span className="px-1.5 py-0.5 text-[8px] font-bold bg-emerald-500/5 text-slate-500 rounded">Login</span>
                  <div className="w-4 h-4 rounded-full bg-indigo-600 flex items-center justify-center text-[8px] font-bold text-white">D</div>
                </div>
              </div>
            </div>
      ...
      <section id="features" className="max-w-7xl mx-auto w-full px-6 py-20 relative z-10 border-t border-white/5 scroll-mt-24">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-slate-400 mt-2 text-sm max-w-md mx-auto">
            Nous avons conçu chaque interaction pour qu'elle soit intuitive, réactive et agréable.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <div className="glass-panel p-6 rounded-2xl border border-white/5 flex flex-col justify-between hover:border-indigo-500/20 transition-all duration-300 group">
            <div>
              ...
              <h3 className="text-base font-bold text-white mb-2">Drag & Drop Fluide</h3>
              <p className="text-xs text-slate-400 leading-relaxed">
                Glissez et déposez vos tâches instantanément au sein des colonnes sans aucune saccade visuelle.
              </p>
            </div>
          </div>
          ...
          <div className="glass-panel p-6 rounded-2xl border border-white/5 flex flex-col justify-between hover:border-indigo-500/20 transition-all duration-300 group">
            <div>
              ...
              <h3 className="text-base font-bold text-white mb-2">Toasts & Modales</h3>
              <p className="text-xs text-slate-400 leading-relaxed">
                Remplacement complet des alertes par défaut par des dialogues en verre dépoli et des toasts animés.
              </p>
            </div>
          </div>
          ...
          <div className="glass-panel p-6 rounded-2xl border border-white/5 flex flex-col justify-between hover:border-indigo-500/20 transition-all duration-300 group">
            <div>
              ...
              <h3 className="text-base font-bold text-white mb-2">Sécurité intégrée</h3>
              <p className="text-xs text-slate-400 leading-relaxed">
                Session persistante sécurisée et routeur protégeant automatiquement vos espaces de travail.
              </p>
            </div>
          </div>
          ...
          <div className="glass-panel p-6 rounded-2xl border border-white/5 flex flex-col justify-between hover:border-indigo-500/20 transition-all duration-300 group">
            <div>
              ...
              <h3 className="text-base font-bold text-white mb-2">Haute Performance</h3>
              <p className="text-xs text-slate-400 leading-relaxed">
                Re-rendering optimisé, requêtes API parallélisées et base de données Prisma pour une rapidité absolue.
              </p>
            </div>
          </div>
      ...
      <section id="technologies" className="max-w-7xl mx-auto w-full px-6 py-20 relative z-10 border-t border-white/5 scroll-mt-24">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 max-w-4xl mx-auto">
          ...
          <div className="flex flex-col items-center justify-center p-6 rounded-xl bg-white/[0.02] border border-white/5 text-center">
            <span className="text-2xl font-bold bg-gradient-to-r from-blue-400 to-indigo-400 bg-clip-text text-transparent">React 19</span>
            <span className="text-[10px] text-slate-500 mt-1 uppercase tracking-wider font-semibold">Frontend</span>
          </div>

          <div className="flex flex-col items-center justify-center p-6 rounded-xl bg-white/[0.02] border border-white/5 text-center">
            <span className="text-2xl font-bold bg-gradient-to-r from-cyan-400 to-teal-400 bg-clip-text text-transparent">Tailwind v4</span>
            <span className="text-[10px] text-slate-500 mt-1 uppercase tracking-wider font-semibold">Styles</span>
          </div>

          <div className="flex flex-col items-center justify-center p-6 rounded-xl bg-white/[0.02] border border-white/5 text-center">
            <span className="text-2xl font-bold bg-gradient-to-r from-emerald-400 to-green-400 bg-clip-text text-transparent">Prisma</span>
            <span className="text-[10px] text-slate-500 mt-1 uppercase tracking-wider font-semibold">Database ORM</span>
          </div>

          <div className="flex flex-col items-center justify-center p-6 rounded-xl bg-white/[0.02] border border-white/5 text-center">
            <span className="text-2xl font-bold bg-gradient-to-r from-fuchsia-400 to-pink-400 bg-clip-text text-transparent">Node.js</span>
            <span className="text-[10px] text-slate-500 mt-1 uppercase tracking-wider font-semibold">Backend API</span>
          </div>
      ...
      {/* Footer */}
      <footer className="border-t border-white/5 bg-slate-950/60 backdrop-blur-md px-6 py-8 mt-auto relative z-10 text-xs text-slate-500">
        <div className="max-w-7xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-6">
            <span>© {new Date().getFullYear()} KanbanFlow. Tous droits réservés.</span>
          </div>
